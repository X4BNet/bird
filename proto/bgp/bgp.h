...
int bgp_rte_recalculate(rtable_private *table, net *net, struct rte_storage *new, struct rte_storage *old, struct rte_storage *old_best);
struct rta *bgp_rte_modify_stale(struct rte_storage *r, struct linpool *pool);
void bgp_rt_notify(struct proto *P, struct channel *C, linpool *lp, const net_addr *n, rte *new, rte *old);
int bgp_preexport(struct rt_export_request *, struct rte *);
